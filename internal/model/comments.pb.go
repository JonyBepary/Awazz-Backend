...
type Comments struct {
	...
	Replies     int64                  `protobuf:"varint,9,opt,name=replies,proto3" json:"replies,omitempty"`
...
func (x *Comments) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *Comments) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *Comments) GetCreatedDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Comments) GetUpdatedDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Comments) GetLikes() int64 {
	if x != nil {
		return x.Likes
	}
	return 0
...
func (x *Comments) GetReplies() int64 {
	if x != nil {
		return x.Replies
	}
	return 0
...
func (x *Comments) GetIsDeleted() bool {
	if x != nil {
		return x.IsDeleted
	}
	return false
...
func (x *Comments) GetIsUpdated() bool {
	if x != nil {
		return x.IsUpdated
	}
	return false
...
var file_comments_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x02, 0x0a, 0x08, 0x43, 0x6f, 0x6d,
	...
	0x70, 0x52, 0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x65, 0x12, 0x3d,
	0x0a, 0x0c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x52, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x65, 0x12, 0x14, 0x0a,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x65, 0x73, 0x12, 0x1d, 0x0a,
	...
	0x69, 0x73, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x09, 0x69, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_comments_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_comments_proto_goTypes = []interface{}{
	(*Comments)(nil),              // 0: model.Comments
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_comments_proto_depIdxs = []int32{
	1, // 0: model.Comments.created_date:type_name -> google.protobuf.Timestamp
	1, // 1: model.Comments.updated_date:type_name -> google.protobuf.Timestamp
